...
class Connection(models.Model):
    ...
    fk_connection_departure = models.ForeignKey(
        Iata, on_delete=models.DO_NOTHING, related_name='connection_departure',
    )
    fk_connection_destination = models.ForeignKey(
        Iata, on_delete=models.DO_NOTHING, related_name='connection_destination',
    )
